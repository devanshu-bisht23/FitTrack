import { ActivityIcon, HomeIcon, MoonIcon, PersonStandingIcon, SunIcon, UserIcon, UtensilsIcon, FootprintsIcon  } from "lucide-react"
...
const Sidebar = () => {
    ...
    const navItems = [
        ...
        {path: '/live-steps', label: 'Live Steps', icon: FootprintsIcon}, // for live steps
