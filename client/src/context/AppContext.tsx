...
import { initialState, type ActivityEntry, type Credentials, type FoodEntry, type User, type StepEntry } from "../types";
...
export const AppProvider = ({children} : {children: React.ReactNode})=>{
    ...
    const [allStepLogs, setAllStepLogs] = useState<StepEntry[]>([])
    ...
    // New function to fetch step logs
    const fetchStepLogs = async (token: string) => {
        try {
            const { data } = await api.get('/api/step-logs', {
    ...
    const value = {
        ...
        allFoodLogs, allActivityLogs, allStepLogs,
        setAllFoodLogs, setAllActivityLogs, setAllStepLogs,
    }
